...
const Login = () => {
  ...
  return (
    <><Box w={windowSize.width} bgColor={"#6D31ED"}>
      <Box sx={{ flexGrow: 1 }}  height={532}>
        <HStack>
        <Box width={windowSize.width/2}>
          ...
          <Box height={460} width={560} marginTop={40} ml={30} bgColor='#B9B2FE' border="GrayText" borderRadius={10} p={36}>
          <form>
